...
<form class = 'cad-turma' action="turmaController.php?acao=cadastrar" method="POST">
...
<span style="padding-bottom: 20px; font-size: 13px;">Idioma</span>
    ...
    <input type="date" id="data" class="form-input" name="dtini"  required>
    ...
    <input type="submit" class="button-cad" value="Adicionar Alunos" name = 'addaluno' >
    <br>
